(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('rxjs/operators'), require('@angular/core'), require('@ngneat/transloco')) :
    typeof define === 'function' && define.amd ? define('@ngneat/transloco-locale', ['exports', 'rxjs', 'rxjs/operators', '@angular/core', '@ngneat/transloco'], factory) :
    (factory((global.ngneat = global.ngneat || {}, global.ngneat['transloco-locale'] = {}),global.rxjs,global.rxjs.operators,global.ng.core,global.i1));
    ...
    ***************************************************************************** */
    ...
    /** @type {?} */
    var LOCALE_DEFAULT_LOCALE = new i0.InjectionToken('DEFAULT_LOCALE');
    /** @type {?} */
    var LOCALE_LANG_MAPPING = new i0.InjectionToken('LOCALE_LANG_MAPPING');
    /** @type {?} */
    var LOCALE_CONFIG = new i0.InjectionToken('LOCALE_CONFIG');
    /** @type {?} */
    var LOCALE_CURRENCY_MAPPING = new i0.InjectionToken('LOCALE_CURRENCY_MAPPING');
    ...
    var TranslocoLocaleService = /** @class */ (function () {
        function TranslocoLocaleService(translocoService, langLocaleMapping, defaultLocale, localeConfig, localeCurrencyMapping, numberTransformer, dateTransformer) {
            ...
            this.locale = new rxjs.BehaviorSubject(this._locale);
            this.localeChanges$ = this.locale.asObservable().pipe(operators.distinctUntilChanged());
            this.subscription = translocoService.langChanges$
                .pipe(operators.map(this.toLocale.bind(this)), operators.filter(( /**
         * @param {?} lang
         * @return {?}
        ...
        /** @nocollapse */
        TranslocoLocaleService.ctorParameters = function () {
            return [
    ...
    var TranslocoCurrencyPipe = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        TranslocoCurrencyPipe.ctorParameters = function () {
            return [
    ...
    var TranslocoDatePipe = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        TranslocoDatePipe.ctorParameters = function () {
            return [
                { type: TranslocoLocaleService },
                { type: i0.ChangeDetectorRef },
                { type: undefined, decorators: [{ type: i0.Inject, args: [LOCALE_CONFIG,] }] }
    ...
    var TranslocoDecimalPipe = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        TranslocoDecimalPipe.ctorParameters = function () {
            return [
                { type: TranslocoLocaleService },
                { type: i0.ChangeDetectorRef },
                { type: undefined, decorators: [{ type: i0.Inject, args: [LOCALE_CONFIG,] }] }
    ...
    var TranslocoPercentPipe = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        TranslocoPercentPipe.ctorParameters = function () {
            return [
                { type: TranslocoLocaleService },
                { type: i0.ChangeDetectorRef },
                { type: undefined, decorators: [{ type: i0.Inject, args: [LOCALE_CONFIG,] }] }
    ...
    exports.TranslocoLocaleService = TranslocoLocaleService;
    exports.defaultConfig = defaultConfig;
    exports.LOCALE_DEFAULT_LOCALE = LOCALE_DEFAULT_LOCALE;
    exports.LOCALE_LANG_MAPPING = LOCALE_LANG_MAPPING;
    exports.LOCALE_CONFIG = LOCALE_CONFIG;
    exports.LOCALE_CURRENCY_MAPPING = LOCALE_CURRENCY_MAPPING;
    exports.pipes = pipes;
    exports.TranslocoLocaleModule = TranslocoLocaleModule;
    exports.TranslocoDatePipe = TranslocoDatePipe;
    exports.TranslocoCurrencyPipe = TranslocoCurrencyPipe;
    exports.TranslocoPercentPipe = TranslocoPercentPipe;
...
//# sourceMappingURL=ngneat-transloco-locale.umd.js.map